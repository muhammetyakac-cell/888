...
const char* supabaseBaseUrl = "https://phicbgmciqrfeuwbnlrv.supabase.co/rest/v1/devices?id=eq.1";
const char* supabaseLogsUrl = "https://phicbgmciqrfeuwbnlrv.supabase.co/rest/v1/device_logs";
const char* supabaseKey     = "sb_publishable_KsP-lQCVJyafRSMlN_5h2Q_tjlXNayt";
...
// ============================================================
//  SUPABASE PATCH (devices - anlık durum)
// ============================================================
...
void setup() {
  ...
  // Stack 16000'e çıkarıldı, watchdog init YOK
...
void loop() {
  ...
  // Güç simülasyonu: 1 saniyede bir
